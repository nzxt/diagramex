...
Snap.plugin(  function( Snap, Element, Paper, global ) {
  Paper.prototype.connection = function (obj1, obj2, line, bg) {
    ...
    var arrow = this.polyline(0,0,4,2,0,4,0,0).attr({fill: 'red'})
    var arrowMarker = arrow.marker(0,0,4,4,4,2).attr({markerUnits:'strokeWidth',markerWidth:10,markerHeight:10, orient:"auto"})
